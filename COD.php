...
date_default_timezone_set("Asia/Kolkata");
   ...
   $query = "INSERT INTO transaction_ids (id, t_id, mail, addr, amount, date, status) 
              VALUES ('NULL' ,'" . $tnumber . "','" . $mail . "','" . $addr . "','" . $gtotal . "','" . $order_date . "','" . $status . "')";    
...
<h2 class="text-center"> Thank you for shopping at DESI KITCHEN! The ordering process is now complete.</h2>



<h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo "$tnumber"; ?></span> </h3>
